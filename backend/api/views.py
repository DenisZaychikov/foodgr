...
class RecipeViewSet(viewsets.ModelViewSet):
    ...
    def download_shopping_cart(self, request):
        # TODO group_by sql, group_by in django, сгруппировать recipe_ingrs по имени и по единицам измерения
        ingredients_count = {}
        ...
        for shopping_cart in shopping_carts:
            ...
            for recipe_ingredient in recipe_ingredients:
                key = f'{recipe_ingredient.ingredient.name} ({recipe_ingredient.ingredient.measurement_unit})'
...
class CustomUserViewSet(UserViewSet):
    ...
    def subscriptions(self, request):
        ...
        serializer = SubscriptionSerializer(recipe_authors, many=True)
        serializer.is_valid()
